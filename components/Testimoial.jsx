...
const Testimonial = () => {
  return (
    <div className='container py-5 sm:py-10 grid-cols-2 px-5 sm:px-0'>
...
// grid-cols-[300px,1fr]   bu ifade iki sutun olusturur ilk sutuna 300px verir ikinci sutuna kalan alani verir
